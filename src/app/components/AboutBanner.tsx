...
const heroTitle = "Мы создаём стеклянную магию".split("");
...
export default function AboutBanner() {
  return (
    ...
    >
      ...
      <h1 className="text-5xl md:text-7xl font-extrabold mb-6 drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] tracking-tight inline-block">
        {heroTitle.map((letter, i) => (
          <motion.span
            key={i}
            custom={i}
            initial="hidden"
