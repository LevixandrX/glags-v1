...
// Удаляем неиспользуемые sectionVariants, cardVariants
...
export default function DeliveryAndPaymentSection() {
  return (
    ...
    >
      ...
      <div className="relative bg-[#181818] p-6 rounded-xl border-2 border-pink-500/20 shadow-[0_4px_50px_rgba(255,105,180,0.15)] transition-all duration-600 w-full">
      ...
      <div className="relative bg-[#181818] p-6 rounded-xl border-2 border-amber-400/20 shadow-[0_4px_50px_rgba(67,58,20,0.15)] transition-all duration-600 w-full">
      ...
      <div className="relative bg-[#181818] p-6 rounded-xl border-2 border-blue-400/20 shadow-[0_4px_50px_rgba(106,40,255,0.15)] transition-all duration-600 w-full">
        <div className="flex flex-col md:flex-row items-center gap-6">
          <Image
          ...
          <div>
            ...
            <p className="text-white/80 text-lg leading-loose">
              Доставка по всему миру. Упаковка: гриппер, полиэтилен, вспененная плёнка, картонный короб с двойным скотчем, деревянная обрешётка (кроме «Почты России»). Посылка маркируется «СТЕКЛО!!!» с реквизитами внутри.
            </p>
          </div>
        </div>
      </div>
