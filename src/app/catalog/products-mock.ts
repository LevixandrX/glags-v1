...
export const products: Product[] = [
  {
    ...
    variants: [
      { name: 'оригинал', images: ['/images/dragon1.jpg'] },
      { name: 'чёрный', images: ['/images/dragon2.jpg'] },
      { name: 'тёмный', images: ['/images/dragon3.jpg'] },
      { name: 'ночь', images: ['/images/dragon4.jpg'] },
      { name: 'нефть', images: ['/images/dragon5.jpg'] },
    ],
    sizes: [
